# Databricks notebook source exported at Tue, 23 Aug 2016 20:59:10 UTC
# MAGIC %md
...
movie_names_df = movie_ids_with_avg_ratings_df.join(movies_df, movies_df.ID == movie_ids_with_avg_ratings_df.movieId, how = 'left_outer')
...
print movies_with_500_ratings_or_more.count()
...
# import pyspark
# print dir(pyspark.ml.evaluation.RegressionEvaluator)
...
predicted_highest_rated_movies_df = predicted_with_counts_df.sort('prediction').filter("count > 75")
